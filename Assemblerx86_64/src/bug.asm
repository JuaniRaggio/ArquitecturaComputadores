...
;;; Esta mal pasarle el valor derecho del buffer, hay que pasarle una direc
;;; de memoria
...
;; Primer error: no se fija si es una letra, es decir que si le paso un tab,
;; le va a sumar 20h de igual forma
